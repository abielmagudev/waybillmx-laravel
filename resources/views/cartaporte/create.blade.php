...
<div class="card border-0 shadow">
    <div class="card-header">
        <span class="lead">Nueva carta porte</span>
    </div>
    <form action="{{ route('cartasporte.store') }}" class="card-body" method="post">
        ...
        <div class="form-group">
            ...
            <ul>
                ...
                <li>Alias del sucursal obtenido del usuario live</li>
                <li>[0-9]: Numero consecutivo o autoincremental segun su registro</li>
                <li>Serie se genera y se guarda en un campo despues de guardar</li>
            </ul>
        </div>
        ...
        <p class="text-right">
            <button class="btn btn-success" type="button">Guardar carta porte</button>
        </p>
    </form>
</div>
